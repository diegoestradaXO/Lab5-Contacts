...
/*
ContentProvider que presta los servicios para una DB y declara las funciones de DELETE, UPDATE E INSERT.
 */
class ContactProvider : ContentProvider() {
    ...
    //FUNCION QUE INSERTARA LOS CONTACTOS EN LA DB
    ...
    companion object {
        internal val PROVIDER_NAME = "com.example.diego.appcontactos.ContactProvider"
